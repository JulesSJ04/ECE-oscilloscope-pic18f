...
void __attribute__((picinterrupt(("")))) irq_handle();
# 8 "./my_lib.h" 2
...
void display_oscillo(int ADC_value)
{
    ...
    need_osc_refresh = 1;
    if(need_osc_refresh == 1 || current_oscillo_mode == 1)
    {
...
void display_rectangle(void)
{
    ...
    {
        glcd_WriteString(mode1,1,1);
        frequence = ADRESH;
        frequence = map(frequence, 0, 244, 490, 62500);
    }
    else
    {
        glcd_WriteString(mode2,1,1);
        dutycycle = ADRESH;
        dutycycle = map(dutycycle, 0, 244, 0, 100);
    }

    display_line(56,47,56,55,1);
    display_line(57,47,57,55,1);

    glcd_SetCursor(62,6);
 glcd_WriteString(string2,1,1);

    glcd_SetCursor(114,6);
    glcd_WriteString(percent,1,1);

    glcd_SetCursor(11,7);
 glcd_WriteString(string1,1,1);

    glcd_SetCursor(102,7);
 glcd_WriteString(hz,1,1);

    display_line(0,46,128,46,1);
    ...
    glcd_SetCursor(86,6);
    glcd_WriteString(string_d_digit1,1,1);
    glcd_SetCursor(95,6);
    glcd_WriteString(string_d_digit2,1,1);
    glcd_SetCursor(104,6);
    glcd_WriteString(string_d_digit3,1,1);

    glcd_SetCursor(51,7);
    glcd_WriteString(string_f_digit1,1,1);
    glcd_SetCursor(60,7);
    glcd_WriteString(string_f_digit2,1,1);
    glcd_SetCursor(74,7);
    glcd_WriteString(string_f_digit3,1,1);
    glcd_SetCursor(83,7);
    glcd_WriteString(string_f_digit4,1,1);
    glcd_SetCursor(92,7);
    glcd_WriteString(string_f_digit5,1,1);
    ...
    PWM1_setFreqDC(dutycycle, frequence);
