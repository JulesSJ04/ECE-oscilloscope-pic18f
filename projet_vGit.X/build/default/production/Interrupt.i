...
void __attribute__((picinterrupt(("low_priority")))) irq_handle_low()
{
    if(PIR1bits.ADIF == 1)
    {
        PIR1bits.ADIF = 0;
...
void __attribute__((picinterrupt(("high_priority")))) irq_handle_high()
{
    ...
    if(INTCONbits.RBIF == 1)
    {
        ...
        if(PORTBbits.RB6 == 1)
        {
            if(double_edge == 0)
            {
                ...
                else if(currently_in_rectangle == 1 && current_rectangle_mode == 1)
                {
                    double_edge++;
                ...
                else if(currently_in_rectangle == 1 && current_rectangle_mode == 0)
                {
                    double_edge++;
                    current_rectangle_mode = 1;
